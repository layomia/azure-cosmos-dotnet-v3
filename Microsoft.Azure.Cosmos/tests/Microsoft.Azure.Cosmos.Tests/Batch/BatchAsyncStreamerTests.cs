...
namespace Microsoft.Azure.Cosmos.Tests
{
    ...
    public class BatchAsyncStreamerTests
    {
        ...
        {
            BatchAsyncStreamer batchAsyncStreamer = new BatchAsyncStreamer(size, MaxBatchByteSize, DispatchTimerInSeconds, this.TimerPool, new CosmosSystemTextJsonSerializer(), this.Executor, this.Retrier);
        }
        ...
        {
            BatchAsyncStreamer batchAsyncStreamer = new BatchAsyncStreamer(1, MaxBatchByteSize, dispatchTimerInSeconds, this.TimerPool, new CosmosSystemTextJsonSerializer(), this.Executor, this.Retrier);
        }
        ...
        {
            BatchAsyncStreamer batchAsyncStreamer = new BatchAsyncStreamer(1, MaxBatchByteSize, DispatchTimerInSeconds, this.TimerPool, new CosmosSystemTextJsonSerializer(), null, this.Retrier);
        }
        ...
        {
            BatchAsyncStreamer batchAsyncStreamer = new BatchAsyncStreamer(1, MaxBatchByteSize, DispatchTimerInSeconds, this.TimerPool, new CosmosSystemTextJsonSerializer(), this.Executor, null);
        }
        ...
        {
            BatchAsyncStreamer batchAsyncStreamer = new BatchAsyncStreamer(2, MaxBatchByteSize, DispatchTimerInSeconds, this.TimerPool, new CosmosSystemTextJsonSerializer(), this.ExecutorWithFailure, this.Retrier);
        ...
        public async Task TimerDispatchesAsync()
        {
            ...
            BatchAsyncStreamer batchAsyncStreamer = new BatchAsyncStreamer(2, MaxBatchByteSize, DispatchTimerInSeconds, this.TimerPool, new CosmosSystemTextJsonSerializer(), this.Executor, this.Retrier);
            ItemBatchOperationContext context = AttachContext(this.ItemBatchOperation);
            batchAsyncStreamer.Add(this.ItemBatchOperation);
